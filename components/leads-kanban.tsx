              ...
              {estagios.sort((a, b) => a.ORDEM - b.ORDEM).map((estagio) => {
                ...
                return (
                  <TabsContent key={estagio.CODESTAGIO} value={estagio.CODESTAGIO} className="mt-4">
                    ...
                    <div className="bg-card rounded-lg overflow-hidden shadow-sm border border-border mb-4">
                      <div 
                      ...
                      {isLoading ? (
                        ...
                        leadsList.map((lead, index) => (
                          <div
                            ...
                            onClick={() => handleEdit(lead)}
                            className="bg-card rounded-lg shadow-sm hover:shadow-md transition-all cursor-pointer border border-border relative overflow-hidden"
                          >
