                ...
                {loading ? (
                  ...
                  produtosFiltrados.map((product) => (
                    <tr key={product._id || product.CODPROD} className="hover:bg-muted/50 transition-colors">
                      <td className="px-2 md:px-6 py-2 md:py-4 text-[11px] md:text-sm text-foreground">{product.CODPROD}</td>
                      <td className="px-2 md:px-6 py-2 md:py-4 text-[11px] md:text-sm text-foreground">{product.DESCRPROD}</td>
                      <td className="px-2 md:px-6 py-2 md:py-4 text-[11px] md:text-sm text-foreground hidden lg:table-cell">{product.MARCA || '-'}</td>
                      <td className="px-2 md:px-6 py-2 md:py-4 text-[11px] md:text-sm text-foreground hidden xl:table-cell">{product.UNIDADE || '-'}</td>
                      <td className="px-2 md:px-6 py-2 md:py-4">
                        <Button
                          size="sm"
                          onClick={() => abrirModal(product)}
                          className="bg-primary hover:bg-primary/90 text-primary-foreground font-medium uppercase text-[10px] md:text-xs flex items-center gap-1 px-2 py-1 md:px-3 h-7 md:h-9"
                        >
