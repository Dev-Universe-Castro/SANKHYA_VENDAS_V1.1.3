                ...
                {isLoading ? (
                  ...
                  filteredUsers.map((user) => (
                    <tr key={user.id} className="hover:bg-muted/50 transition-colors">
                      <td className="px-2 md:px-6 py-2 md:py-4 text-[11px] md:text-sm text-foreground">{user.id}</td>
                      <td className="px-2 md:px-6 py-2 md:py-4 text-[11px] md:text-sm text-foreground">{user.name}</td>
                      <td className="px-2 md:px-6 py-2 md:py-4 text-[11px] md:text-sm text-foreground">{user.email}</td>
                      ...
                      <td className="px-2 md:px-6 py-2 md:py-4 text-[11px] md:text-sm">{getStatusBadge(user.status)}</td>
                      {isAdmin && (
                            ...
                            {user.status === "pendente" ? (
                              <>
                                <Button
                                  ...
                                  className="bg-green-500 hover:bg-green-600 text-white font-medium uppercase text-[10px] md:text-xs flex items-center gap-1 px-2 py-1 h-7 md:h-9"
                                >
                                ...
                                <Button
                                  ...
                                  className="bg-red-500 hover:bg-red-600 text-white font-medium uppercase text-[10px] md:text-xs flex items-center gap-1 px-2 py-1 h-7 md:h-9"
                                >
                                  <X className="w-3 h-3" />
                                  Bloquear
                                </Button>
                              ...
                              <>
                                <Button
                                  ...
                                  className="bg-primary hover:bg-primary/90 text-primary-foreground font-medium uppercase text-[10px] md:text-xs flex items-center gap-1 px-2 py-1 h-7 md:h-9"
                                >
                                ...
                                <Button
                                  ...
                                  className="font-medium uppercase text-[10px] md:text-xs flex items-center gap-1 px-2 py-1 h-7 md:h-9"
