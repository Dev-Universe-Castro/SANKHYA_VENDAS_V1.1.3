          ...
          <div className="overflow-x-auto md:overflow-y-auto md:max-h-[calc(100vh-400px)]">
            <table className="w-full">
              ...
              <tbody className="divide-y divide-border">
                {isLoading ? (
                  <tr>
                    <td colSpan={4} className="px-2 md:px-6 py-8 md:py-12 text-center">
                  ...
                  partners.map((partner) => (
                    <tr key={partner.CODPARC} className="hover:bg-muted/50 transition-colors">
                      <td className="px-2 md:px-6 py-2 md:py-4 text-[11px] md:text-sm font-medium text-foreground">{partner.CODPARC}</td>
                      <td className="px-2 md:px-6 py-2 md:py-4 text-[11px] md:text-sm text-foreground">{partner.NOMEPARC}</td>
                      <td className="px-2 md:px-6 py-2 md:py-4 text-[11px] md:text-sm text-foreground hidden lg:table-cell">{partner.CGC_CPF || '-'}</td>
